  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <p className={`text-lg ${errors.length > 0 ? 'text-red-600' : 'text-green-600'}`}>
          {connectionStatus}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="border rounded-lg p-4">
          ...
          <div className="space-y-1 text-sm">
            {citiesData.map((city) => (
              <div key={city.id} className="bg-gray-100 p-2 rounded">
                <div className="font-medium">{city.name}</div>
                <div className="text-gray-600">{city.department_id}</div>
              </div>
            ))}
          </div>
        </div>
