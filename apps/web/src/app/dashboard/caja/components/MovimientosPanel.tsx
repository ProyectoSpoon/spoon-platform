...
const EmptyState: React.FC<{
  ...
  <div className="text-center py-12">
    ...
    <h3 className="heading-section text-gray-900 mb-2">{title}</h3>
    ...
    switch (subTab) {
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      {orden.detalles && (
                        <p className="text-sm text-gray-600 mb-2">{orden.detalles}</p>
                      )}
        ...
        return (
          <div className="space-y-3">
            {transacciones.map((transaccion) => (
              <Card key={transaccion.id} className="border-l-4 border-l-green-500">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-2">
      ...
      case 'egresos':
        ...
        return (
          <div className="space-y-3">
            {gastos.map((gasto) => (
              <Card key={gasto.id} className="border-l-4 border-l-red-500">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-2">
      ...
      <div className="flex space-x-1 bg-gray-50 rounded-lg p-1 w-fit">
        {subTabs.map((tab) => (
          <Button
            ...
            className={`${subTab === tab.key ? 'bg-white shadow-sm' : ''} relative`}
          >
            {tab.label}
            {tab.count > 0 && (
